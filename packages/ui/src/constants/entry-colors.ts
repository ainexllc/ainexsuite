 ...
 */
export const ENTRY_COLORS: Array<{
  id: EntryColor;
  label: string;
  swatchClass: string;
  iconClass: string;
 ...
 */
export function getEntryColorConfig(colorId: EntryColor = 'default') {
...
export const ENTRY_COLOR_SWATCHES: { value: EntryColor; label: string; className: string }[] = [
  ...
  { value: 'entry-white', label: 'White', className: 'bg-[#ffffff]' },
  { value: 'entry-lemon', label: 'Lemon', className: 'bg-[#fff9c4]' },
  { value: 'entry-peach', label: 'Peach', className: 'bg-[#ffe0b2]' },
  { value: 'entry-tangerine', label: 'Tangerine', className: 'bg-[#ffccbc]' },
  { value: 'entry-mint', label: 'Mint', className: 'bg-[#c8e6c9]' },
  { value: 'entry-fog', label: 'Fog', className: 'bg-[#cfd8dc]' },
  { value: 'entry-lavender', label: 'Lavender', className: 'bg-[#d1c4e9]' },
  { value: 'entry-blush', label: 'Blush', className: 'bg-[#f8bbd0]' },
