...
interface HintProps {
  ...
  children: ReactNode;
  /** Additional condition to show the hint (e.g., "no habits exist") */
  showWhen?: boolean;
...
const arrowStyles: Record<HintPlacement, string> = {
  top: 'top-full left-1/2 -translate-x-1/2 border-t-teal-500 border-x-transparent border-b-transparent',
  bottom: 'bottom-full left-1/2 -translate-x-1/2 border-b-teal-500 border-x-transparent border-t-transparent',
  left: 'left-full top-1/2 -translate-y-1/2 border-l-teal-500 border-y-transparent border-r-transparent',
  right: 'right-full top-1/2 -translate-y-1/2 border-r-teal-500 border-y-transparent border-l-transparent',
};
