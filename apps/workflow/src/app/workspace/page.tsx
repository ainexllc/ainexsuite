      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <header
          ...
          style={{
            ...
            boxShadow: '0 8px 30px -12px rgba(168, 85, 247, 0.3)'
          }}
        >
        ...
        <main className="flex-1 overflow-x-hidden pt-16">
          <div className="max-w-7xl 2xl:max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <section className="space-y-6">
              ...
              {/* Workflow Canvas */}
              <div className="h-[calc(100vh-200px)] min-h-[600px] rounded-xl border border-white/10 bg-[#0a0a0a] backdrop-blur overflow-hidden">
                <WorkflowCanvas />
              </div>
            </section>
          </div>
