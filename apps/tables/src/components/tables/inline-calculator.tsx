...
export function InlineCalculator({ onInsert, onClose }: InlineCalculatorProps) {
  ...
  const operatorClass = clsx(buttonClass, "bg-blue-500/80 text-white hover:bg-blue-500");
  ...
  return (
    <div className="rounded-xl bg-[#1a1a1a]/95 backdrop-blur-xl border border-white/10 shadow-2xl p-3 w-[220px]">
      ...
      <button
        ...
        className="w-full mt-3 py-2 rounded-lg bg-blue-500 text-white text-xs font-medium hover:bg-blue-400 transition"
      >
        Insert into doc
      </button>
    </div>
