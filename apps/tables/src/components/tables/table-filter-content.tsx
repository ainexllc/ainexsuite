...
const TABLE_COLORS: { value: TableColor; label: string; className: string }[] = [
  { value: 'default', label: 'Default', className: 'bg-background' },
  { value: 'table-white', label: 'White', className: 'bg-[#ffffff]' },
  { value: 'table-lemon', label: 'Lemon', className: 'bg-[#fff9c4]' },
  { value: 'table-peach', label: 'Peach', className: 'bg-[#ffe0b2]' },
  { value: 'table-tangerine', label: 'Tangerine', className: 'bg-[#ffccbc]' },
  { value: 'table-mint', label: 'Mint', className: 'bg-[#c8e6c9]' },
  { value: 'table-fog', label: 'Fog', className: 'bg-[#cfd8dc]' },
  { value: 'table-lavender', label: 'Lavender', className: 'bg-[#d1c4e9]' },
  { value: 'table-blush', label: 'Blush', className: 'bg-[#f8bbd0]' },
  { value: 'table-sky', label: 'Sky', className: 'bg-[#b3e5fc]' },
  { value: 'table-moss', label: 'Moss', className: 'bg-[#dcedc8]' },
  { value: 'table-coal', label: 'Coal', className: 'bg-[#455a64]' },
];
...
const DATE_FIELD_OPTIONS: { value: DateRangeField; label: string }[] = [
  ...
  { value: 'noteDate', label: 'Table Date' },
];
...
export function TableFilterContent({ filters, onFiltersChange, sort }: TableFilterContentProps) {
  ...
  const setTableType = (noteType: NoteTypeFilter) => {
