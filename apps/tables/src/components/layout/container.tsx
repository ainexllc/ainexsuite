...
const variantClassMap: Record<ContainerVariant, string> = {
  ...
  narrow:
    "max-w-[min(100%,var(-table-board-max-width-sm))] md:max-w-[min(100%,var(-table-board-max-width-md))] xl:max-w-[min(100%,var(-table-board-max-width-lg))] 2xl:max-w-[min(100%,var(-table-board-max-width-xl))]",
  full: "max-w-none",
};
