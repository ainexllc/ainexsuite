...
import type { SpaceMember, SpaceMemberRole } from '@/lib/types/table';
        ...
        <div className="w-full max-w-md bg-[#1a1a1a] border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-6 text-center">
            ...
            <p className="text-sm text-white/60 mb-4">
              ...
              Personal docs can&apos;t be shared with others.
            </p>
            <button
              onClick={onClose}
              ...
              {inviteTab === 'quick' && (
                <form onSubmit={handleQuickAdd} className="space-y-3">
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-lg py-2 px-3 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-amber-500"
                    required
                  />

                  <button
                    type="submit"
                    className="w-full px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white rounded-lg text-sm font-medium flex items-center justify-center gap-2"
                  >
                ...
                <form onSubmit={handleEmailInvite} className="space-y-3">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-lg py-2 pl-9 pr-4 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-amber-500"
                      required
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2 bg-amber-500 hover:bg-amber-600 disabled:opacity-50 text-white rounded-lg text-sm font-medium flex items-center justify-center gap-2"
                  >
                    {inviteSending ? (
                      <>
