...
const heroHighlights = [
  ...
  },
  {
    ...
    description: 'AI distills long docs into action items, highlights, and next-step prompts.',
  },
];
...
const workspaceFeatures = [
  {
    ...
    description: 'Craft meeting docs, research outlines, or creative briefs with custom sections and layouts.',
  },
  {
    title: 'Living collections',
    description: 'Curate docs into collections that update automatically—perfect for projects, clients, or themes.',
  },
  {
    title: 'Team-ready sharing',
    description: 'Share docs with granular permissions. Add comments, tasks, and references without version chaos.',
  },
];
      ...
      <div className="space-y-16">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-white/70">
              ...
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong className="text-white">Publish-ready exports:</strong> Turn docs into docs, slides, or shareable recaps with one click.
                </span>
              </li>
            </ul>
          </div>
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-accent-500/10 to-accent-600/10 p-8 shadow-lg space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-white/70 leading-relaxed">
                  Tag docs with #roadmap, share recap with leadership, draft 3 concept statements before next sprint review.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-zinc-800/80 to-zinc-900/80 p-8 shadow-lg space-y-6">
            <h2 className="text-2xl font-semibold text-white">Why table users choose AINex Notes</h2>
            <ul className="space-y-4 text-white/70">
              <li className="flex items-start gap-3">
                <FileText className="h-5 w-5 text-accent-300 mt-1" />
              ...
              <li className="flex items-start gap-3">
                <Share2 className="h-5 w-5 text-accent-300 mt-1" />
                <span>Turn docs into polished outputs—docs, decks, summaries—with zero copy-paste time.</span>
              </li>
            </ul>
          </div>
        </section>
