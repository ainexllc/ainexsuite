 ...
 * Request Body:
 * {
 *   "app": "tables" | "journey" | "todo" | "health" | "moments" | "grow" | "pulse" | "fit"
 * }
 *
 * Response:
 * {
 *   "success": true,
 *   "redirect"?: "https://www.ainexspace.com/workspace?activated=docs"
 * }
 */

const VALID_APPS = ['tables', 'journey', 'todo', 'health', 'moments', 'grow', 'pulse', 'fit'];
