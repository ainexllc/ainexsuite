...
export const metadata: Metadata = {
  title: "Tables • Spreadsheets for data organization",
  description:
    "A modern spreadsheet application for data organization, calculations, and simple databases.",
  icons: {
    icon: '/favicon.svg',
  },
};
    ...
    <html lang="en" suppressHydrationWarning className={theme}>
      ...
      >
        <ThemeProvider defaultTheme={theme} enableSystem={true} storageKey="ainex-theme">
          <AuthProvider>
            <AppColorProvider appId="tables" fallbackPrimary="#10b981" fallbackSecondary="#059669">
