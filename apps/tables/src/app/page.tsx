...
const demoSteps: DemoStep[] = [
  ...
  { text: 'Drafting prompts so your next table starts focused…', emoji: '✨' },
];
...
const featureCards: FeatureCard[] = [
  {
    ...
    description:
      'Drop in ideas from voice, handwriting, or web snippets. Tables auto-transcribe, tag, and sync instantly.',
    icon: PenSquare,
  },
  {
    title: 'Dynamic Knowledge Spaces',
    description:
      'Group tables into living canvases that reveal themes, backlinks, and dependencies without manual sorting.',
    icon: FolderTree,
  },
  {
...
const resourceLinks: FooterLink[] = [
  ...
  { label: 'Contact Us', href: 'mailto:tables@ainexspace.com' },
...
function TablesHomePageContent() {
  const { user, loading } = useAuth();
  const { needsActivation, checking } = useAppActivation('tables');
  ...
  useEffect(() => {
    ...
    if (user && !needsActivation) {
      setLoadingMessage('Welcome back! Redirecting you to your tables workspace…');
    ...
    <>
      <HomepageTemplate
        ...
        hero={{
          ...
          subheadline: 'AINex Tables transforms scattered thoughts into searchable insight.',
          ...
          highlights: [
            ...
            },
            {
              ...
              description: 'Every table ends with highlights, next steps, and shareable briefs.',
            },
          ],
        }}
        login={{
          badgeText: 'Early Creators',
          signUpTitle: 'Join AINex Tables',
          signInTitle: 'Welcome back',
          signUpDescription: 'Create your account to unlock AI-accelerated table-taking.',
        ...
        features={{
          ...
          sectionDescription: 'Whether you\'re drafting a product spec or personal journal, Tables keeps every insight discoverable.',
          cards: featureCards,
        }}
        footer={{
          appDisplayName: "AINex Tables",
          productLinks,
          companyLinks,
          resourceLinks,
          legalLinks,
