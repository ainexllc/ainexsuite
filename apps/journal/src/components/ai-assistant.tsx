...
export function AIAssistant() {
  ...
  const { messages, sendMessage, loading } = useGrokAssistant({
    appName: 'journal',
    systemPrompt: `You are a supportive AI journal assistant.

Your role is to help users:
- Process their emotions and thoughts
- Find patterns in their journal entries
- Suggest prompts for reflection
- Provide gentle encouragement
- Offer perspective on their experiences

Be empathetic, non-judgmental, and supportive. Keep responses concise and thoughtful.`,
  });
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {messages.length === 0 ? (
              <div className="text-center text-ink-600 py-8 space-y-2 text-sm">
                <p>I&#39;m here to help with your journaling!</p>
                <p>Ask me for:</p>
                <p>• Reflection prompts</p>
                <p>• Pattern insights</p>
