          ...
          {isPersonalSpace ? (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-zinc-500 dark:text-zinc-400 max-w-xs mx-auto">
                This is your personal space. Journal entries here are private and only visible to you.
              </p>
              <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-4">
                Select a family or custom space to share journal entries with others.
              </p>
            </div>
          ) : (
            <div className="space-y-4">
              ...
              {/* Invite button */}
              <button className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl border-2 border-dashed border-zinc-300 dark:border-zinc-700 text-zinc-500 dark:text-zinc-400 hover:border-orange-500 hover:text-orange-500 transition-colors">
