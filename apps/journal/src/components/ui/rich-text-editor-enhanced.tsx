...
import { getAdaptiveToolbarClass, getAdaptiveIconButtonClass, getAdaptiveBorderClass, getAdaptiveTextClass } from '@/lib/adaptive-styles';
import {
  Bold,
  Italic,
  List,
  ...
  const ToolbarButton = ({
    ...
    <button
      ...
      className={cn(
        ...
        getAdaptiveIconButtonClass(brightness, isActive),
  ...
  return (
    <>
      <div className="rounded-lg overflow-hidden">
        <div className={cn(
          "border-b px-2 py-1.5 flex items-center gap-1 flex-wrap",
          getAdaptiveToolbarClass(brightness)
        )}>
          ...
          <div className={cn("w-px h-6", brightness === 'dark' ? "bg-white/20" : brightness === 'light' ? "bg-black/10" : "bg-zinc-200 dark:bg-white/20")} />
          ...
          {uploadingImages.size > 0 && (
            <>
              ...
              <div className={cn(
                "text-sm px-2",
                brightness === 'dark' ? "text-white/80" : brightness === 'light' ? "text-zinc-700" : "text-orange-600 dark:text-orange-400"
              )}>
        ...
        <div
          ...
          className={cn(
            ...
            brightness ? "bg-transparent" : "bg-white dark:bg-zinc-900"
          )}
        >
          <input {...getInputProps()} />
          ...
          <EditorContent
            ...
            className={cn(
              ...
              brightness === 'light' && "[&_.ProseMirror]:text-zinc-900 [&_.ProseMirror_p.is-editor-empty:first-child::before]:text-zinc-500"
            )}
          />
        ...
        {editor && (() => {
          ...
          return (
            <div className={cn(
              ...
              getAdaptiveBorderClass(brightness),
              getAdaptiveTextClass(brightness, 'muted')
            )}>
              <div className="flex items-center gap-3">
                <span>{words} {words === 1 ? 'word' : 'words'}</span>
                <span className={brightness === 'dark' ? "text-white/30" : brightness === 'light' ? "text-black/20" : "text-zinc-300 dark:text-zinc-600"}>·</span>
