...
export function WorkoutComposer({ onWorkoutCreated }: WorkoutComposerProps) {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      const newWorkout: Workout = {
        ...
        userId: user.uid,
        spaceId: currentSpaceId !== 'personal' ? currentSpaceId : undefined,
        title: title.trim(),
  ...
  }, [user, title, date, duration, exercises, feeling, currentSpaceId, addWorkout, onWorkoutCreated, resetState]);
