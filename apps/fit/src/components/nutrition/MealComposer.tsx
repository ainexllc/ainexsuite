    ...
    <div className="space-y-6">
      ...
      {foods.length > 0 && (
        <div>
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-16 px-2 py-1 border border-border rounded text-center text-sm bg-background"
                  />
          ...
          {/* Totals */}
          <div className="mt-4 p-3 bg-[hsl(var(--app-primary))]/10 rounded-lg">
      ...
      >
        <h2 className="text-xl font-bold text-foreground mb-4">Create Custom Food</h2>
        <FoodEditor
