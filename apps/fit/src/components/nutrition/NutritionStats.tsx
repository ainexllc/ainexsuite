...
export function NutritionStats({ summary, goals }: NutritionStatsProps) {
  ...
  return (
    <div className="p-4 bg-background/60 border border-border rounded-xl space-y-6 backdrop-blur-xl">
      {/* Main Calorie Ring */}
      <div className="flex items-center gap-6">
        <div className="relative w-24 h-24 flex-shrink-0">
          <svg className="w-full h-full -rotate-90" viewBox="0 0 36 36">
            ...
            <circle
              ...
              r="15.9"
              fill="none"
              className={caloriePercentage > 100 ? 'stroke-red-500' : 'stroke-[hsl(var(--app-primary))]'}
              strokeWidth="3"
              strokeLinecap="round"
        ...
        <div className="flex-1 space-y-2">
          <h3 className="font-semibold text-foreground">Daily Nutrition</h3>
          ...
          <div className="flex gap-4 text-sm">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-muted-foreground">F: {Math.round(totals.fat)}g</span>
            </div>
          </div>
        </div>
      </div>
