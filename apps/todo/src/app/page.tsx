...
type PublicTodoHomePageProps = {
  showActivation?: boolean;
  onActivated?: () => void;
  onSwitchToLogin?: () => void;
};

function PublicTodoHomePage({
  showActivation = false,
  onActivated,
  onSwitchToLogin,
}: PublicTodoHomePageProps) {
      ...
      <main className="pt-28">
            ...
            <div className="space-y-8">
              ...
              <h1 className="text-4xl font-semibold leading-tight sm:text-5xl lg:text-6xl">
                <span className="bg-gradient-to-r from-[#FF7A18] to-[#FFB347] bg-clip-text text-transparent">
                  Plan boldly. Finish consistently.
                </span>
                <br />
                <span className="text-white">AINex Tasks keeps your commitments aligned with your focus.</span>
              </h1>
              <p className="text-lg text-white/70 sm:text-xl">
                Combine projects, rituals, and meetings into one adaptive command center. AI ensures every priority
                has space to breathe—and gets done.
              </p>
              ...
              <div className="grid gap-4 rounded-3xl border border-white/10 bg-zinc-800/80 p-5 backdrop-blur sm:grid-cols-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-white">Workflow Templates</p>
                    <p className="text-xs text-white/60">Save your best routines as reusable blueprints with AI handoff.</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#f97316]/10 text-[#f97316]">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-white">Team Assignments</p>
                    <p className="text-xs text-white/60">Delegate with context and automatic updates when priorities shift.</p>
                  </div>
                </div>
              </div>
            ...
            {showActivation ? (
              ...
              <div id="login" className="relative mb-[75px]">
                ...
                <div className="mb-6 flex items-start justify-between">
                  <div className="space-y-2">
                    ...
                    <h2 className="text-3xl font-semibold text-white">
                      {isSignUp ? 'Join AINex Tasks' : 'Welcome back'}
                    </h2>
                    <p className="text-sm text-white/70">
                      {isSignUp
                        ? 'Create your account to orchestrate projects with AI.'
                        : 'Sign in to access your adaptive planning workspace.'}
                    </p>
                  </div>
                ...
                <div className="mt-4 text-center text-xs text-white/60">
                  {isSignUp ? 'Already planning with us?' : 'Need an account?'}{' '}
                  <button
                    type="button"
                    onClick={() => {
                ...
                <p className="mt-4 text-xs text-white/50 text-center">
                  Your tasks stay encrypted, exportable, and synced across every Ainex app.
                </p>
              </div>
            </div>
            )}
        ...
        <section id="features" className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-5xl -mt-8">
            <div className="relative aspect-video overflow-hidden rounded-3xl border border-white/10 bg-zinc-800/80 shadow-lg">
              <iframe
                ...
                src="https://www.youtube.com/embed/Gdsc5B6UE9M"
                title="AINex Tasks demo"
          ...
          <div className="mx-auto mt-16 max-w-3xl text-center">
            <h2 className="text-3xl font-semibold text-white sm:text-4xl">Built for operators who refuse busywork</h2>
            <p className="mt-3 text-lg text-white/70">
              From solo founders to cross-functional teams, AINex Tasks keeps everyone locked on outcomes—not checklists.
            </p>
          </div>
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col gap-10 lg:flex-row lg:items-center">
              <div className="flex-1 space-y-6">
                <h2 className="text-3xl font-semibold text-white sm:text-4xl">An AI operations partner in your pocket</h2>
                <p className="text-lg text-white/70">
                  Tasks learns how you work, surfaces hidden blockers, and keeps everyone aligned without micro-managing.
                </p>
              ...
              <div className="flex-1">
                <div className="rounded-3xl border border-white/10 bg-zinc-800/80 p-6 shadow-lg">
                  <div className="flex items-center gap-3 rounded-full border border-white/10 bg-zinc-700/60 px-4 py-2 text-sm text-white/60">
                    <AlarmClock className="h-5 w-5 text-[#f97316]" />
                    Morning focus window locked in
                  </div>
                  <div className="mt-6 space-y-4 text-sm text-white/70">
                    <div className="rounded-2xl border border-white/10 bg-black/40 p-4">
                      <div className="flex items-center justify-between">
                        <span className="font-semibold text-white">Today&apos;s Agenda</span>
                      ...
                      <p className="mt-2 text-white/60">
                        Deep work block, stakeholder sync, and launch prep automatically sequenced for momentum.
                      </p>
                    </div>
                    <div className="rounded-2xl border border-white/5 bg-gradient-to-r from-[#f97316]/10 via-transparent to-[#6366f1]/20 p-4">
                      <p className="text-xs uppercase tracking-[0.2em] text-white/40">Saved Routines</p>
