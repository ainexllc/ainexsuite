...
type PublicPulseHomePageProps = {
  showActivation?: boolean;
  onActivated?: () => void;
  onSwitchToLogin?: () => void;
};

function PublicPulseHomePage({
  showActivation = false,
  onActivated,
  onSwitchToLogin,
}: PublicPulseHomePageProps) {
      ...
      <main className="pt-28">
            ...
            <div className="space-y-8">
              ...
              <h1 className="text-4xl font-semibold leading-tight sm:text-5xl lg:text-6xl">
                <span className="bg-gradient-to-r from-[#FF7A18] to-[#FFB347] bg-clip-text text-transparent">
                  Know your body. Act with confidence.
                </span>
                <br />
                <span className="text-white">AINex Pulse is your AI health analyst and wellness copilot.</span>
              </h1>
              <p className="text-lg text-white/70 sm:text-xl">
                Track vital signals, catch trend shifts early, and get practical guidance tailored to your lifestyle and goals.
              </p>
              ...
              <div className="grid gap-4 rounded-3xl border border-white/10 bg-zinc-800/80 p-5 backdrop-blur sm:grid-cols-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-white">Real-time Vital Sync</p>
                    <p className="text-xs text-white/60">Continuous updates from wearables, bloodwork, and manual entries.</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#f97316]/10 text-[#f97316]">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-white">Care Collaboration</p>
                    <p className="text-xs text-white/60">Share curated insights with providers using secure invite links.</p>
                  </div>
                </div>
              </div>
            ...
            {showActivation ? (
              ...
              <div id="login" className="relative mb-[75px]">
                ...
                <div className="mb-6 flex items-start justify-between">
                  <div className="space-y-2">
                    ...
                    <h2 className="text-3xl font-semibold text-white">
                      {isSignUp ? 'Join AINex Pulse' : 'Welcome back'}
                    </h2>
                    <p className="text-sm text-white/70">
                      {isSignUp
                        ? 'Create your account to connect data and unlock AI wellness insights.'
                        : 'Sign in to access your personalized health control center.'}
                    </p>
                  </div>
                ...
                <div className="mt-4 text-center text-xs text-white/60">
                  {isSignUp ? 'Already monitoring with us?' : 'Need an account?'}{' '}
                  <button
                    type="button"
                    onClick={() => {
                ...
                <p className="mt-4 text-xs text-white/50 text-center">
                  Encrypted end-to-end. You control sharing and export with a single tap.
                </p>
              </div>
            </div>
            )}
        ...
        <section id="features" className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-5xl -mt-8">
            <div className="relative aspect-video overflow-hidden rounded-3xl border border-white/10 bg-zinc-800/80 shadow-lg">
              <iframe
                ...
                src="https://www.youtube.com/embed/tlzItgRZt1Q"
                title="AINex Pulse overview"
          ...
          <div className="mx-auto mt-16 max-w-3xl text-center">
            <h2 className="text-3xl font-semibold text-white sm:text-4xl">Built for longevity seekers and wellness teams</h2>
            <p className="mt-3 text-lg text-white/70">
              From athletes to executives, Pulse keeps your health data actionable, comprehensible, and connected.
            </p>
          </div>
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col gap-10 lg:flex-row lg:items-center">
              <div className="flex-1 space-y-6">
                <h2 className="text-3xl font-semibold text-white sm:text-4xl">An AI wellness team at your side</h2>
                <p className="text-lg text-white/70">
                  Pulse combines trend analytics, habit intelligence, and real-time alerts so you always know what to do next.
                </p>
              ...
              <div className="flex-1">
                <div className="rounded-3xl border border-white/10 bg-zinc-800/80 p-6 shadow-lg">
                  <div className="flex items-center gap-3 rounded-full border border-white/10 bg-zinc-700/60 px-4 py-2 text-sm text-white/60">
                    ...
                    Live readiness insight delivered
                  </div>
                  <div className="mt-6 space-y-4 text-sm text-white/70">
                    <div className="rounded-2xl border border-white/10 bg-black/40 p-4">
                      <div className="flex items-center justify-between">
                        <span className="font-semibold text-white">Today&apos;s Health Brief</span>
                      ...
                      <p className="mt-2 text-white/60">
                        HRV trending up 6%, sleep debt cleared, hydration below target. Suggested afternoon mobility + electrolytes.
                      </p>
                    </div>
                    <div className="rounded-2xl border border-white/5 bg-gradient-to-r from-[#f97316]/10 via-transparent to-[#6366f1]/20 p-4">
                      <p className="text-xs uppercase tracking-[0.2em] text-white/40">Programs</p>
