...
type PublicMomentsHomePageProps = {
  showActivation?: boolean;
  onActivated?: () => void;
  onSwitchToLogin?: () => void;
};

function PublicMomentsHomePage({
  showActivation = false,
  onActivated,
  onSwitchToLogin,
}: PublicMomentsHomePageProps) {
      ...
      <main className="pt-28">
          ...
          <div className="relative mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(320px,0.9fr)] lg:items-center lg:px-8">
            <div className="space-y-8">
              ...
              <h1 className="text-4xl font-semibold leading-tight sm:text-5xl lg:text-6xl">
                ...
                <br />
                <span className="text-white">AINex Moments turns memories into immersive stories.</span>
              </h1>
              <p className="text-lg text-white/70 sm:text-xl">
                Collect photos, videos, and reflections in one secure space, then let AI transform them into experiences worth sharing.
              </p>
              ...
              <div className="grid gap-4 rounded-3xl border border-white/10 bg-zinc-800/80 p-5 backdrop-blur sm:grid-cols-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-white">Smart Collections</p>
                    <p className="text-xs text-white/60">Memories auto-group by emotion, location, and cast members.</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#f97316]/10 text-[#f97316]">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-white">Effortless Sharing</p>
                    <p className="text-xs text-white/60">Deliver curated reels or private links with built-in access controls.</p>
                  </div>
                </div>
              </div>
            ...
            {showActivation ? (
              ...
              <div id="login" className="relative mb-[75px]">
                ...
                <div className="mb-6 flex items-start justify-between">
                  <div className="space-y-2">
                    ...
                    <h2 className="text-3xl font-semibold text-white">
                      {isSignUp ? 'Join AINex Moments' : 'Welcome back'}
                    </h2>
                    <p className="text-sm text-white/70">
                      {isSignUp
                        ? 'Create your account to craft cinematic memories with AI.'
                        : 'Sign in to access your private gallery vault.'}
                    </p>
                  </div>
                ...
                <div className="mt-4 text-center text-xs text-white/60">
                  {isSignUp ? 'Already capturing with us?' : 'Need an account?'}{' '}
                  <button
                    type="button"
                    onClick={() => {
                ...
                <p className="mt-4 text-xs text-white/50 text-center">
                  Memories stay encrypted, watermark-free, and always under your control.
                </p>
              </div>
            </div>
            )}
        ...
        <section id="features" className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-5xl -mt-8">
            <div className="relative aspect-video overflow-hidden rounded-3xl border border-white/10 bg-zinc-800/80 shadow-lg">
              <iframe
                ...
                src="https://www.youtube.com/embed/nm-iAP0-8lQ"
                title="AINex Moments demo"
          ...
          <div className="mx-auto mt-16 max-w-3xl text-center">
            <h2 className="text-3xl font-semibold text-white sm:text-4xl">Built for storytellers, families, and creators</h2>
            <p className="mt-3 text-lg text-white/70">
              Moments keeps your life’s highlight reel organized, beautiful, and ready to relive.
            </p>
          </div>
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col gap-10 lg:flex-row lg:items-center">
              <div className="flex-1 space-y-6">
                <h2 className="text-3xl font-semibold text-white sm:text-4xl">An AI producer for your favorite memories</h2>
                <p className="text-lg text-white/70">
                  Moments transforms raw captures into polished stories, while preserving the authenticity that makes them yours.
                </p>
              ...
              <div className="flex-1">
                <div className="rounded-3xl border border-white/10 bg-zinc-800/80 p-6 shadow-lg">
                  <div className="flex items-center gap-3 rounded-full border border-white/10 bg-zinc-700/60 px-4 py-2 text-sm text-white/60">
                    ...
                    Sunset beach captured
                  </div>
                  <div className="mt-6 space-y-4 text-sm text-white/70">
                    <div className="rounded-2xl border border-white/10 bg-black/40 p-4">
                      <div className="flex items-center justify-between">
                        <span className="font-semibold text-white">Highlight Reel</span>
                      ...
                      <p className="mt-2 text-white/60">
                        Soft light, laughter audio, ocean ambience layered behind key moments. Ready to send to the family group chat.
                      </p>
                    </div>
                    <div className="rounded-2xl border border-white/5 bg-gradient-to-r from-[#f97316]/10 via-transparent to-[#6366f1]/20 p-4">
                      <p className="text-xs uppercase tracking-[0.2em] text-white/40">Collections</p>
...
export default function MomentsHomePage() {
  ...
  useEffect(() => {
    ...
    if (user && !needsActivation) {
      setLoadingMessage('Welcome back! Redirecting you to your gallery…');
