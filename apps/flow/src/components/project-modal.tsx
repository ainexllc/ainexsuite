    ...
    <div className="fixed inset-0 bg-background/50 flex items-center justify-center z-50">
      <div className="bg-foreground rounded-lg p-6 w-full max-w-md">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-background">Create New Project</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {ideaNote && (
            <div className="mb-4 p-3 bg-background/50 rounded-md">
              <p className="text-sm text-muted-foreground">From idea:</p>
              <p className="text-sm font-medium text-background">{ideaNote.content}</p>
            </div>
          )}
          ...
          <div className="flex justify-end space-x-3">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 text-background border border-border rounded-md hover:bg-background/10"
            >
              Cancel
            </button>
            <button
