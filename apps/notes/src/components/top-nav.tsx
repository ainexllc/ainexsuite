...
import { StickyNote, LogOut, LayoutDashboard } from 'lucide-react';
  ...
  return (
    <nav className="h-16 surface-elevated border-b border-surface-hover flex items-center justify-between px-6 sticky top-0 z-40">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-note-yellow to-note-orange flex items-center justify-center">
          <StickyNote className="h-5 w-5 text-surface-base" />
        </div>
        <div>
          <h1 className="font-brand font-semibold text-lg">Notes</h1>
          <p className="text-xs text-ink-600">Capture your thoughts</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            ...
            <div className="text-xs text-ink-600">Notes</div>
          </div>
