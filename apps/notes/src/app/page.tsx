      ...
      <main className="pt-28">
            ...
            <div className="space-y-8">
              ...
              <h1 className="text-4xl font-semibold leading-tight sm:text-5xl lg:text-6xl">
                <span className="bg-gradient-to-r from-[#FF7A18] to-[#FFB347] bg-clip-text text-transparent">
                  Capture. Synthesize. Share clarity.
                </span>
                <br />
                <span className="text-white">AINex Notes transforms scattered thoughts into searchable insight.</span>
              </h1>
              <p className="text-lg text-white/70 sm:text-xl">
                Record ideas from anywhere, organize them automatically, and surface connections you didn’t know existed.
              </p>
              ...
              <div className="grid gap-4 rounded-3xl border border-white/10 bg-zinc-800/80 p-5 backdrop-blur sm:grid-cols-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-white">Living Libraries</p>
                    <p className="text-xs text-white/60">Build narrative hubs that update as your projects evolve.</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#f97316]/10 text-[#f97316]">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-white">Instant Summaries</p>
                    <p className="text-xs text-white/60">Every note ends with highlights, next steps, and shareable briefs.</p>
                  </div>
                </div>
              </div>
            ...
            {showActivation ? (
              ...
              <div id="login" className="relative mb-[75px]">
                ...
                <div className="mb-6 flex items-start justify-between">
                  <div className="space-y-2">
                    ...
                    <h2 className="text-3xl font-semibold text-white">
                      {isSignUp ? 'Join AINex Notes' : 'Welcome back'}
                    </h2>
                    <p className="text-sm text-white/70">
                      {isSignUp
                        ? 'Create your account to unlock AI-accelerated note-taking.'
                        : 'Sign in to access your connected knowledge workspace.'}
                    </p>
                  </div>
                ...
                <p className="mt-4 text-xs text-white/50 text-center">
                  Your ideas stay encrypted and private. Export anytime.
                </p>
              </div>
            </div>
            )}
        ...
        <section id="features" className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-5xl -mt-8">
            <div className="relative aspect-video overflow-hidden rounded-3xl border border-white/10 bg-zinc-800/80 shadow-lg">
              <iframe
                ...
                src="https://www.youtube.com/embed/2QznyN9l0SI"
                title="AINex Notes walkthrough"
          ...
          <div className="mx-auto mt-16 max-w-3xl text-center">
            <h2 className="text-3xl font-semibold text-white sm:text-4xl">Built for thinkers, strategists, and storytellers</h2>
            <p className="mt-3 text-lg text-white/70">
              Whether you’re drafting a product spec or personal journal, Notes keeps every insight discoverable.
            </p>
          </div>
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col gap-10 lg:flex-row lg:items-center">
              <div className="flex-1 space-y-6">
                <h2 className="text-3xl font-semibold text-white sm:text-4xl">A thinking partner inside every note</h2>
                <p className="text-lg text-white/70">
                  AI reads along, surfaces patterns, and keeps your knowledge base alive with context-rich insights.
                </p>
              ...
              <div className="flex-1">
                <div className="rounded-3xl border border-white/10 bg-zinc-800/80 p-6 shadow-lg">
                  <div className="flex items-center gap-3 rounded-full border border-white/10 bg-zinc-700/60 px-4 py-2 text-sm text-white/60">
                    ...
                    Morning reflection ready for review
                  </div>
                  <div className="mt-6 space-y-4 text-sm text-white/70">
                    <div className="rounded-2xl border border-white/10 bg-black/40 p-4">
                      <div className="flex items-center justify-between">
                        <span className="font-semibold text-white">Daily Brief</span>
                      ...
                      <p className="mt-2 text-white/60">
                        Key decisions, open questions, and follow-up ideas ready to share with your team.
                      </p>
                    </div>
                    <div className="rounded-2xl border border-white/5 bg-gradient-to-r from-[#f97316]/10 via-transparent to-[#6366f1]/20 p-4">
                      <p className="text-xs uppercase tracking-[0.2em] text-white/40">Workspaces</p>
