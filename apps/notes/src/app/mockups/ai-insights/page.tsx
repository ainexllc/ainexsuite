...
const sampleInsights = [
  {
    icon: TrendingUp,
    label: "Productivity",
    content: "You've written 12 notes this week - 40% more than last week!",
    gradient: { from: "#eab308", to: "#f97316" }
  },
  {
    icon: Lightbulb,
    label: "Suggestion",
    content: "Consider organizing your 'Project Ideas' notes into a dedicated workspace.",
    gradient: { from: "#eab308", to: "#84cc16" }
  },
  {
    icon: Target,
    label: "Focus Area",
    content: "Your most active category is 'Development' with 28 notes.",
