...
const DOC_COLORS: { value: DocColor; label: string; className: string }[] = [
  { value: 'default', label: 'Default', className: 'bg-background' },
  { value: 'doc-white', label: 'White', className: 'bg-[#ffffff]' },
  { value: 'doc-lemon', label: 'Lemon', className: 'bg-[#fff9c4]' },
  { value: 'doc-peach', label: 'Peach', className: 'bg-[#ffe0b2]' },
  { value: 'doc-tangerine', label: 'Tangerine', className: 'bg-[#ffccbc]' },
  { value: 'doc-mint', label: 'Mint', className: 'bg-[#c8e6c9]' },
  { value: 'doc-fog', label: 'Fog', className: 'bg-[#cfd8dc]' },
  { value: 'doc-lavender', label: 'Lavender', className: 'bg-[#d1c4e9]' },
  { value: 'doc-blush', label: 'Blush', className: 'bg-[#f8bbd0]' },
  { value: 'doc-sky', label: 'Sky', className: 'bg-[#b3e5fc]' },
  { value: 'doc-moss', label: 'Moss', className: 'bg-[#dcedc8]' },
  { value: 'doc-coal', label: 'Coal', className: 'bg-[#455a64]' },
];
...
interface DocFilterContentProps {
  filters: FilterValue;
  onFiltersChange: (filters: FilterValue) => void;
  sort?: SortConfig;
}

export function DocFilterContent({ filters, onFiltersChange, sort }: DocFilterContentProps) {
  ...
  const setDocType = (noteType: NoteTypeFilter) => {
