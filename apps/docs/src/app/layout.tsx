...
export const metadata: Metadata = {
  title: "Docs • Capture and organize ideas effortlessly",
  description:
    "A modern document management surface with powerful organization, collaboration, and insight features.",
  icons: {
    icon: '/favicon.svg',
  },
};
    ...
    <html lang="en" suppressHydrationWarning className={theme}>
      ...
      >
        <ThemeProvider defaultTheme={theme} enableSystem={true} storageKey="ainex-theme">
          <AuthProvider>
            <AppColorProvider appId="docs" fallbackPrimary="#f59e0b" fallbackSecondary="#d97706">
