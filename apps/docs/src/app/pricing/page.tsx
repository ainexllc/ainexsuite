...
const faqs = [
  ...
  {
    question: 'Can I export my docs if I cancel?',
    answer:
      'Yes. You can export individual docs or entire collections as Markdown, PDF, or JSON. We retain your account data for 90 days in case you reactivate.',
  },
];
        ...
        <section className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-zinc-800/80 to-zinc-900/80 p-8 shadow-lg space-y-6">
            ...
            <ul className="space-y-3 text-sm text-white/70">
              <li className="flex items-start gap-3">
                <Check className="h-5 w-5 text-[var(--color-secondary)] mt-0.5" />
                <span>Unlimited doc capture and instant syncing.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="h-5 w-5 text-[var(--color-secondary)] mt-0.5" />
