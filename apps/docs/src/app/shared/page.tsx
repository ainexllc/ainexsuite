...
import { SharedDocsBoard } from "@/components/docs/shared-docs";
          ...
          <header className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted">
                Invite teammates, assign roles, and stay aligned across every shared doc.
              </p>
            </div>
            <Link
              href="/workspace"
            ...
            >
              <Share2 className="h-4 w-4" /> Share a doc
            </Link>
          </header>
