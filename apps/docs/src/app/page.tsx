...
const demoSteps: DemoStep[] = [
  ...
  { text: 'Drafting prompts so your next doc starts focused…', emoji: '✨' },
];
...
const featureCards: FeatureCard[] = [
  ...
  },
  {
    ...
    description:
      'Group docs into living canvases that reveal themes, backlinks, and dependencies without manual sorting.',
    icon: FolderTree,
  },
  {
...
const resourceLinks: FooterLink[] = [
  ...
  { label: 'Contact Us', href: 'mailto:docs@ainexspace.com' },
...
function NotesHomePageContent() {
  ...
  const { needsActivation, checking } = useAppActivation('docs');
  ...
  useEffect(() => {
    ...
    if (user && !needsActivation) {
      setLoadingMessage('Welcome back! Redirecting you to your docs workspace…');
  ...
  return (
    <>
      <HomepageTemplate
        logo={<AinexStudiosLogo align="center" size="lg" asLink={false} appName="docs" appColor={primary} />}
        ...
        hero={{
          ...
          highlights: [
            ...
            },
            {
              ...
              description: 'Every doc ends with highlights, next steps, and shareable briefs.',
            },
          ],
        }}
        login={{
          ...
          signUpDescription: 'Create your account to unlock AI-accelerated doc-taking.',
