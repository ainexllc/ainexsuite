    ...
    <AppShell>
      <div className="space-y-10">
        <PagePlaceholder
          ...
          description="Block distractions, pair your docs with ambient timers, and stay present while capturing ideas."
          actions={
            <Link
              href="/workspace"
        ...
        >
          <div className="grid gap-5 text-left sm:grid-cols-2">
            ...
            <div className="rounded-3xl border border-outline-subtle/60 bg-white/80 px-6 py-5 shadow-sm">
              ...
              <p className="mt-2 text-sm text-muted">
                Pair docs with ambient soundtracks and mark sessions complete to unlock progress streaks.
              </p>
            </div>
