    ...
    <AppShell>
      <div className="space-y-10">
        <PagePlaceholder
          ...
          description="Draft outlines, summarize long docs, and remix ideas into new experiments without leaving your workspace."
          actions={
            <Link
              href="/workspace"
        ...
        >
          <div className="grid gap-5 text-left sm:grid-cols-3">
            ...
            <div className="rounded-3xl border border-outline-subtle/60 bg-white/80 px-6 py-5 shadow-sm">
              ...
              <p className="mt-2 text-sm text-muted">
                Start with interview summaries, design briefs, meeting docs, and more.
              </p>
            </div>
            <div className="rounded-3xl border border-outline-subtle/60 bg-white/80 px-6 py-5 shadow-sm">
              <h2 className="flex items-center gap-2 text-sm font-semibold text-ink-800">
              ...
              <p className="mt-2 text-sm text-muted">
                Feed context from any doc to generate targeted prompts that unblock your thinking.
              </p>
            </div>
          </div>
        </PagePlaceholder>
