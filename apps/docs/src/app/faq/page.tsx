...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      'Yes. Upload handwriting scans or record voice docs and Notes converts them into searchable text. AI tags the content so it flows into the right collections automatically.',
  },
  {
    category: 'Capture',
    question: 'Do you support templates for recurring documents?',
    answer:
      'Absolutely. Save any doc as a template—meeting docs, design briefs, research outlines—and reuse it with pre-filled sections and prompts.',
  },
  {
      ...
      <div className="space-y-12">
        <section className="text-center space-y-4">
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto">
            ...
            <a href="mailto:docs@ainexspace.com" className="text-accent-300 hover:underline">
              docs@ainexspace.com
            </a>
            .
          </p>
