import type { DocPattern } from "@/lib/types/doc";

/**
 * SVG background patterns for docs
 * Each pattern is designed to be subtle (8% opacity) and work on all doc colors
 */

export const DOC_PATTERNS: Array<{
  id: DocPattern;
  label: string;
  description: string;
