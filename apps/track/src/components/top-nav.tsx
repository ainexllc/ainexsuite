  ...
  return (
    <nav className="h-16 surface-elevated border-b border-surface-hover flex items-center justify-between px-6 sticky top-0 z-40">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="font-brand font-semibold text-lg">Track</h1>
          <p className="text-xs text-ink-600">Build better habits</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            ...
            <div className="text-xs text-ink-600">Track</div>
          </div>
