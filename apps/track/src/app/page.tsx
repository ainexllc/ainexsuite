...
type PublicTrackHomePageProps = {
  showActivation?: boolean;
  onActivated?: () => void;
  onSwitchToLogin?: () => void;
};

function PublicTrackHomePage({
  showActivation = false,
  onActivated,
  onSwitchToLogin,
}: PublicTrackHomePageProps) {
      ...
      <main className="pt-28">
            ...
            <div className="space-y-8">
              ...
              <h1 className="text-4xl font-semibold leading-tight sm:text-5xl lg:text-6xl">
                <span className="bg-gradient-to-r from-[#FF7A18] to-[#FFB347] bg-clip-text text-transparent">
                  Small wins. Compounding results.
                </span>
                <br />
                <span className="text-white">AINex Track keeps every habit aligned with your next milestone.</span>
              </h1>
              <p className="text-lg text-white/70 sm:text-xl">
                Build rituals that last, understand your streaks, and let AI coach you through setbacks before they stick.
              </p>
              ...
              <div className="grid gap-4 rounded-3xl border border-white/10 bg-zinc-800/80 p-5 backdrop-blur sm:grid-cols-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-white">Routine Templates</p>
                    <p className="text-xs text-white/60">Start with proven templates or import your own ritual playbooks.</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#f97316]/10 text-[#f97316]">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-white">Daily Reflections</p>
                    <p className="text-xs text-white/60">Capture quick notes after each habit and watch AI surface patterns.</p>
                  </div>
                </div>
              </div>
            ...
            {showActivation ? (
              ...
              <div id="login" className="relative mb-[75px]">
                ...
                <div className="mb-6 flex items-start justify-between">
                  <div className="space-y-2">
                    ...
                    <h2 className="text-3xl font-semibold text-white">
                      {isSignUp ? 'Join AINex Track' : 'Welcome back'}
                    </h2>
                    <p className="text-sm text-white/70">
                      {isSignUp
                        ? 'Create your account to craft consistent habits with AI support.'
                        : 'Sign in to access your habit intelligence hub.'}
                    </p>
                  </div>
                ...
                <div className="mt-4 text-center text-xs text-white/60">
                  {isSignUp ? 'Already growing with us?' : 'Need an account?'}{' '}
                  <button
                    type="button"
                    onClick={() => {
                ...
                <p className="mt-4 text-xs text-white/50 text-center">
                  Your data stays encrypted and portable. Export streaks anytime.
                </p>
              </div>
            </div>
            )}
        ...
        <section id="features" className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-5xl -mt-8">
            <div className="relative aspect-video overflow-hidden rounded-3xl border border-white/10 bg-zinc-800/80 shadow-lg">
              <iframe
                ...
                src="https://www.youtube.com/embed/mgxI8W5fzl0"
                title="AINex Track walkthrough"
          ...
          <div className="mx-auto mt-16 max-w-3xl text-center">
            <h2 className="text-3xl font-semibold text-white sm:text-4xl">Built for ambitious creators and teams</h2>
            <p className="mt-3 text-lg text-white/70">
              Track keeps every habit connected to the bigger picture, so momentum never slips through the cracks.
            </p>
          </div>
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col gap-10 lg:flex-row lg:items-center">
              <div className="flex-1 space-y-6">
                <h2 className="text-3xl font-semibold text-white sm:text-4xl">An AI accountability partner on call</h2>
                <p className="text-lg text-white/70">
                  Track analyzes your routines, surfaces powerful insights, and keeps you accountable with kindness.
                </p>
                  ...
                  <div className="mt-6 space-y-4 text-sm text-white/70">
                    <div className="rounded-2xl border border-white/10 bg-black/40 p-4">
                      <div className="flex items-center justify-between">
                        <span className="font-semibold text-white">Daily Reflection</span>
                      ...
                      <p className="mt-2 text-white/60">
                        Celebrated 12-day streak, highlighted weekend drift risk, suggested Monday buffer block.
                      </p>
                    </div>
