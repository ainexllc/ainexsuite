...
import { X, Trash2, Pin, PinOff, Archive, Palette, Tag, CheckSquare, Square, CheckCircle2 } from 'lucide-react';
import { useState, useRef, useEffect } from 'react';
import { PROJECT_COLOR_SWATCHES } from '@/lib/constants/project-colors';
import type { ProjectColor, ProjectStatus } from '@/lib/types/project';
      ...
      <div className="flex items-center gap-3 px-2 py-2 rounded-full bg-zinc-900/95 dark:bg-zinc-800/95 border border-zinc-700/50 shadow-2xl backdrop-blur-xl">
        ...
        <div className="flex items-center gap-0.5 px-1 py-1 rounded-full bg-white/5 border border-white/10">
          ...
          {onStatusChange && (
            ...
            >
              <CheckCircle2 className="h-4 w-4 text-zinc-400 group-hover:text-green-400 transition-colors" />
            </button>
          )}
