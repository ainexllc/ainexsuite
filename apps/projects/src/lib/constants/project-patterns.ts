import type { ProjectPattern } from "@/lib/types/project";

/**
 * SVG background patterns for projects
 * Each pattern is designed to be subtle (8% opacity) and work on all project colors
 */
