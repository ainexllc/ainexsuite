import type { ProjectColor } from "@/lib/types/project";

/**
 * Project Color Palette - Theme Lab Design System
 *
 ...
 */
export const PROJECT_COLORS: Array<{
  id: ProjectColor;
  label: string;
  swatchClass: string;
  iconClass: string;
...
/**
 * Color swatches for bulk action bar and color pickers
 */
export const PROJECT_COLOR_SWATCHES: Array<{
  value: ProjectColor;
  label: string;
  className: string;
