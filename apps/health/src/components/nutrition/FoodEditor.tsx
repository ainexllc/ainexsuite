  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-xs text-ink-500 mb-1">Calories (kcal)</label>
            <input
              type="number"
              min="0"
              value={nutrition.calories}
              onChange={(e) => handleNutritionChange('calories', parseFloat(e.target.value) || 0)}
              className="w-full px-3 py-2 border border-outline-subtle rounded-lg bg-surface-elevated text-ink-900 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            />
          </div>
          <div>
            <label className="block text-xs text-ink-500 mb-1">Protein (g)</label>
            <input
              type="number"
              min="0"
              step="0.1"
          ...
          <div>
            <label className="block text-xs text-ink-500 mb-1">Carbs (g)</label>
            <input
              type="number"
              min="0"
              step="0.1"
          ...
          <div>
            <label className="block text-xs text-ink-500 mb-1">Fat (g)</label>
            <input
              type="number"
              min="0"
              step="0.1"
          ...
          <div>
            <label className="block text-xs text-ink-500 mb-1">Fiber (g)</label>
            <input
              type="number"
              min="0"
              step="0.1"
          ...
          <div>
            <label className="block text-xs text-ink-500 mb-1">Sugar (g)</label>
            <input
              type="number"
              min="0"
              step="0.1"
